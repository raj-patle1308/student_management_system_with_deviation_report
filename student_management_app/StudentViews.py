...
from student_management_app.models import CustomUser, Staffs, Courses, Subjects, Students, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult ,Timetable
...
def view_timetables(request):
    ...
    return render(request, 'student_template/view_timetable.html', {'timetables': timetables})
