...
urlpatterns = [
    ...
    path('generate_weekly_report/', HodViews.generate_weekly_report, name='generate_weekly_report'),
    path("download_excel_report/", HodViews.download_excel_report, name="download_excel_report"),
    ...
    path('view_timetable/', StaffViews.view_timetable, name='view_timetable'),
    ...
    path('view_timetables/', StudentViews.view_timetables, name='view_timetables'), 
